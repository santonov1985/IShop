                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="brand" required>
                                                    ...
                                                    @foreach($brands as $brand)
                                                        <option value="{{ $brand->id }}" {{ $brand->id == old('brand') ? 'selected':'' }} >{{ $brand->title }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="product-title">Название продукта <span class="important">*</span></label>
                                                <input class="form-control" value="{{ old('title') }}" type="text" name="title" id="product-title" placeholder="Мобильный телефон" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="product-model">Модель <span class="important">*</span></label>
                                                <input class="form-control" value="{{ old('model') }}" type="text" name="model" id="product-model" placeholder="Iphone X" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="product-description">Описание продукта</label>
                                                <textarea class="form-control" placeholder="{{ old('description') }}" rows="3" name="description" id="product-description" style="height: 96px"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" value="{{ old('quantity') }}" type="number" name="quantity" id="product-quantity" placeholder="99" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="product-price">Цена <span class="important">*</span></label>
                                                <input class="form-control" value="{{ old('price') }}" type="number" name="price" id="product-price" placeholder="9999.99" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="product-characteristic">Характеристика продукта</label>
                                                <textarea class="form-control" placeholder="{{ old('characteristic') }}" rows="7" name="characteristic" id="product-characteristic"></textarea>
                                            </div>
                                        </div>
